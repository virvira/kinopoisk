...
def load_data(db):
    data = {
        "movies": [{
            ...
            "title": "Душа",
            "description": "Уже немолодой школьный учитель музыки Джо Гарднер всю жизнь мечтал.",
        ...
        "users": [
            {"email": "ilon.musk@gmail.com", "password": "qwerty", "name": "Ilon", "surname": "Musk",
             "favourite_genre_id": 2, "pk": 1},
            {"email": "gagarin@gmail.com", "password": "test123", "name": "Yuriy", "surname": "Gagarin",
             "favourite_genre_id": 3, "pk": 2}
        ],
    }
    ...
    for user in data["users"]:
        u = User(
            ...
            favourite_genre_id=user["favourite_genre_id"]
        )
        with db.session.begin():
            db.session.add(u)
